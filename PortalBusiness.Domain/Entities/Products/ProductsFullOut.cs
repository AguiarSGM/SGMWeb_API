...
public class ProductsFullOut
{
    ...
    public string dados_comerciais
    {
        ...
        set
        {
            _dados_comerciais = value;
            DadosComerciais = JObject.Parse(value);
        }
    }

    [JsonProperty("dados_comerciais")]
    public JObject DadosComerciais { get; private set; }    

    private string _dados_historicos;

    [JsonIgnore]
    public string dados_historicos
    {
        get => _dados_historicos;
        set
        {
            _dados_historicos = value;
            DadosHistoricos = JObject.Parse(value);
        }
    }

    [JsonProperty("dados_historicos")]
    public JObject DadosHistoricos { get; private set; }

    public ProdutoGrafico ProdutoGrafico { get; set; }
